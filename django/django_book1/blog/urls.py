...
urlpatterns = [
    ...
    path(
        'tag/', views.TagCloudTemplateView.as_view(), name='tag_cloud'
    ),
    path(
    ...
    path('change/', views.PostChangeListView.as_view(), name='change'),
    path(
        '<int:pk>/update/', views.PostUpdateView.as_view(), name='update'
    ),
    path(
